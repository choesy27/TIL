...
def get_melon_best_album(genre_array, play_array):
    ...
    for genre, _value in sorted_genre_play_array:
        ...
        sorted_by_play_and_index_play_index_array = sorted(index_play_array,
...
print("정답 = [4, 1, 3, 0] / 현재 풀이 값 = ",   get_melon_best_album(["classic", "pop", "classic", "classic", "pop"],
                                                               [500, 600, 150, 800, 2500]))
print("정답 = [0, 6, 5, 2, 4, 1] / 현재 풀이 값 = ", get_melon_best_album(["hiphop", "classic", "pop", "classic", "classic", "pop", "hiphop"],
